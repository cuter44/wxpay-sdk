 ...
 */
public class TagsMembersBatchtagging extends WxmpRequestBase
{
  // KEYS
    ...
    public static final String URL_API_BASE = "https://api.weixin.qq.com/cgi-bin/tags/members/batchtagging";
  ...
  // CONSTRUCT
    public TagsMembersBatchtagging(Properties prop)
    {
        super(prop);
  ...
  // BUILD
    @Override
    public TagsMembersBatchtagging build()
    {
  ...
  // EXECUTE
    @Override
    public TagsMembersBatchtaggingResponse execute()
        throws IOException
    {
        ...
        return(new TagsMembersBatchtaggingResponse(respJson));
    }

  // MISC
    public TagsMembersBatchtagging setAccessToken(String accessToken)
    {
    ...
    public TagsMembersBatchtagging setTagid(int tagid)
    {
    ...
    public TagsMembersBatchtagging setTagid(String tagid)
    {
    ...
    public TagsMembersBatchtagging setOpenidList(List<String> list)
    {
    ...
    /** chain method
     */
    public TagsMembersBatchtagging add(String openid)
    {
