...
public abstract class WxcpRequestBase
{
  ...
  // SSL
     ...
     * @return this
     */
    public WxcpRequestBase configHC(SSLContext ctx)
    {
  ...
  // CONSTRUCT
    public WxcpRequestBase(Properties aConf)
    {
        this.conf = aConf;
  ...
  // BUILD
   public abstract WxcpRequestBase build();
  ...
  // EXECUTE
     ...
     */
    public abstract WxcpResponseBase execute()
        throws IOException, WxcpException, UnsupportedOperationException;
