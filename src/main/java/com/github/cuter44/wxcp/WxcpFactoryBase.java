...
public class WxcpFactoryBase
{
  ...
  // HTTP CLIENT
    ...
    /** Prepare a HttpClient and directly assign to <code>WxcpRequestBase.defaultHttpClient</code>.
    ...
    protected void setupHttpClientGlobal()
    {
        ...
        WxcpRequestBase.defaultHttpClient =
  ...
  // ACCESS TOKEN
    /** TokenProviderCp which provides management of <code>access_token</code>.
     */
    protected TokenProviderCp tokenProvider;

    public TokenProviderCp getTokenProvider()
    {
        return(this.tokenProvider);
    }

    /** Initialize TokenProviderCp according to <code>this.conf</code>.
    ...
    protected void initTokenProvider()
    {
        try
        {
            this.tokenProvider = ATMagCp.getDefaultInstance().getOrCreate(this.conf);
        }
        catch (Exception ex)
        {
  ...
  // FACTORY
     ...
     */
    public <X extends WxcpRequestBase> X instantiate(Class<X> clazz)
        throws Exception
    {
        return(
     ...
     */
    public <X extends WxcpRequestBase> X setToken(X req)
    {
     ...
     */
    public <X extends WxcpRequestBase> X setHC(X req)
    {
