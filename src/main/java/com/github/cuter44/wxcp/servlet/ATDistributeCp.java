 ...
 * </pre>
 */
public class ATDistributeCp extends HttpServlet
{
        ...
        throws Exception
    {
        ...
        // else
        throw(new SecurityException("Wxcp:ATDistributeCp:Request rejected:"+c));
    }
    ...
    {
        this.getServletContext().log("Wxcp:ATDistributeCp:FAIL:", ex);
